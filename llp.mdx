...
- The protocol integrates with Meteora to:
    - Allow investments into LP pools.
    - Enable token swaps required for pool participation.
    - Support advanced strategies through DLMM and DAMM V2.
