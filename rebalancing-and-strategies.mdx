...
- For **leveraged positions -**
    1. For leveraged position liquidation mechanism kicks in. 
...
NOTE - If opt for rebalancing there are different options, with the choice of the time of rebalancing.
