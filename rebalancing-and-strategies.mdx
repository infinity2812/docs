...
Rebalancing, if opted, will be triggered by an off-chain monitoring system (also responsible for triggering liquidation).
...
- For **leveraged positions -**
    1. **Add more margin** to maintain healthy LTV
    2. Accept the risk of **partial or full liquidation** 

---

If opt for rebalancing there are different options, with the choice of the time of rebalancing.
