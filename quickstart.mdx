...
<img
  src="/images/flowchart-1.webp"
  alt="Paystream Flowchart 1"
  style={{ width:"100%",maxWidth:"1000px",display:"block",margin:"2rem auto" }}
/>

<img
  src="/images/flowchart-2.webp"
  alt="Paystream Flowchart 2"
  style={{ width:"100%",maxWidth:"1000px",display:"block",margin:"2rem auto" }}
/>

<img
  src="/images/flowchart-3.webp"
  alt="Paystream Flowchart 3"
  style={{ width:"100%",maxWidth:"1000px",display:"block",margin:"2rem auto" }}
/>