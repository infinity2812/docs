...
- **Routing idle liquidity**: When a direct match isn't available, the **Router** routes idle liquidty to LLP pools or the fallback pools , ensuring **highest yield per dollar** on the idle liquidty and thus zero idle capital.
