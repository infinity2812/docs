...
- **Fallback to Liquidity Pools**: When a direct match isn't available, the system utilises external liquidity platforms like Kamino to fulfil requests instantly. This ensures continuous lending opportunities and yield for idle lender capital.
