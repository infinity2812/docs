---
title: "Lending Pool"
description: "Learn about the Lending Pool in PayStream's LLP."
---
...
- **Borrow rate depends on**
    ...
    ![Screenshot 2025-06-26 at 8.56.08 AM.png](./images/Screenshot_2025-06-26_at_8.56.08_AM.png)
    
    instead we can use step based formula that will reduce the computation stuff 
...
## Note - Both **GLI** (for lenders) and **BLI₁ / BLI₂ / BLI₃** (for borrowers) are **updated at regular intervals**, ideally **per block**. 