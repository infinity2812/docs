...
> **Note:**  
> These parameters are carefully chosen to dynamically adjust borrow rates based on utilization.  
> This helps reduce systemic risks, prevent liquidity crunches, and ensure fair interest pricing.

**total borrow rate**

the **borrowing rate** reflects the cumulative interest paid by borrowers on their borrowed principal. It increases over time based on utilization and risk tier, and directly impacts how much debt a borrower owes at the time of repayment.
