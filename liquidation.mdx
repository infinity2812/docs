...
Paystream employs a standard liquidation mechanism, triggered when a borrower’s Loan-To-Value (LTV) ratio exceeds a predefined threshold known as the Liquidation LTV (LLTV). This system is designed to be both reliable and efficient.
...
The standard liquidation system ensures that Paystream remains solvent by allowing unhealthy positions to be corrected swiftly.
