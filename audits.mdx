...
**Disclaimer:** This report is a static report which is very different from a manual audit. This is done through various tools which is good for initial security analysis.
