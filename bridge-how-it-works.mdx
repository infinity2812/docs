...
description: "Technical overview of Paystream's cross-chain bridge mechanism."
---
...
### Core Flow — Technical (concise)

A stripped, implementation-focused summary of Paystream Bridge's routing & execution pipeline.

---
## Bridge Architecture

### Core Flow — Simplified Summary
