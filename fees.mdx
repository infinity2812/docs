...
A one-time fee is charged when a borrower opens a position to take a leverage . This is calculated as a percentage of the borrowed amount.

### Yield-Based Fee (on earned interest)
In certain cases, a minimal fee may be applied on interest earned by the protocol from borrower activity. This supports long-term sustainability and covers protocol-level risks.
...
## LP Position Fees (for Leveraged Borrowers)
